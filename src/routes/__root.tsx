...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Rexxon AI is a business market intelligence platform that turns real-time signals across companies, industries, and markets into decision-ready intelligence for revenue, strategy, and operations teams." },
      { name: "keywords", content: "business market intelligence, market intelligence SaaS, competitive intelligence platform, account intelligence, industry signals, strategic intelligence, AI research, RevOps intelligence" },
      // Open Graph
      { property: "og:site_name", content: "Rexxon AI" },
      { property: "og:type", content: "website" },
      { property: "og:locale", content: "en_US" },
      { property: "og:title", content: "Rexxon AI — Business market intelligence SaaS" },
      { property: "og:description", content: "Real-time market intelligence platform for revenue, strategy, and operations teams. Signals across companies and industries, synthesized by AI." },
      { property: "og:image", content: `${SITE_URL}/og-image.jpg` },
      { property: "og:image:width", content: "1200" },
      { property: "og:image:height", content: "630" },
      { property: "og:image:alt", content: "Rexxon AI — business market intelligence dashboard" },
      // Twitter / X
      ...
      { name: "twitter:description", content: "Real-time market intelligence for revenue, strategy, and operations teams. Signals across companies and industries, synthesized by AI." },
          ...
          "@graph": [
            {
              ...
              description: "Business market intelligence SaaS platform that turns real-time company, industry, and market signals into decision-ready intelligence.",
              sameAs: [
