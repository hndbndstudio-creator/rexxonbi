...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Rexxon AI monitors 10M+ companies for real-time buying signals — hiring, funding, leadership changes, earnings — and drafts AI personalized outreach to verified contacts." },
      ...
      { name: "twitter:title", content: "Rexxon AI — Real-time B2B buying signals & AI outreach" },
      { name: "twitter:description", content: "Rexxon AI monitors 10M+ companies for real-time buying signals — hiring, funding, leadership changes, earnings — and drafts AI personalized outreach to verified contacts." },
